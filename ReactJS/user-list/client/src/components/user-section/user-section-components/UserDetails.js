          ...
          <div className="content">
            ...
            <div className="user-details">
              ...
              <p>
                ...
                <strong>
                  {" "}
                  {UserSectionHelperService.fullName(props.firstName, props.lastName)}{" "}
                </strong>
              </p>
              <p>
              ...
              <p>
                ...
                <strong>
                  {" "}
                  {UserSectionHelperService.address(props.address)}
                </strong>
              </p>
              ...
              <p>
                Created on:{" "}
                <strong>
                  {UserSectionHelperService.formatData(props.createdAt)}
                </strong>
              </p>
              <p>
                Modified on:{" "}
                <strong>
                  {UserSectionHelperService.formatData(props.updatedAt)}
                </strong>
              </p>
            </div>
          </div>
