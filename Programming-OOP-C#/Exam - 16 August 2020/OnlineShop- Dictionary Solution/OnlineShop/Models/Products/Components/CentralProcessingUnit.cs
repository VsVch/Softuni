...
namespace OnlineShop.Models.Products.Components
{
    ...
    {
        private const double CentralProcessingUnitPerformance = 1.25;
        public CentralProcessingUnit(int id, string manufacturer, string model, decimal price, double overallPerformance, int generation)
            : base(id, manufacturer, model, price, overallPerformance * CentralProcessingUnitPerformance, generation)
        {
